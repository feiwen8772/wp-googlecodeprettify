...
(function () {
  ...
  var prettyPrint = (function () {
    ...
    (function () {
       ...
       */
      function numberLines(node, startLineNum, isPreformatted,langExtension) {
        var nocode = /(?:^|\s)nocode(?:\s|$)/;
        var lineBreak = /\r\n?|\n/;
        ...
        if(langExtension){
          var subLang=document.createElement('h6');
          subLang.innerHTML=langExtension+" 代码:";
          node.appendChild(subLang);
        }
      ...
      registerLangHandler(
          ...
          ['default-markup', 'htm', 'html','HTML', 'mxml', 'xhtml', 'xml', 'xsl']);
      registerLangHandler(
          createSimpleLexer(
              [
               [PR_PLAIN,        /^[\s]+/, null, ' \t\r\n'],
          ...
          for (; k < elements.length && clock['now']() < endTime; k++) {
            ...
            if ((attrs !== EMPTY || prettyPrintRe.test(className))
              ...
              if (!nested) {
                ...
                if (lineNums) { numberLines(cs, lineNums, preformatted,langExtension); }
